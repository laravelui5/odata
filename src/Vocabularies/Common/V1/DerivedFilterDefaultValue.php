...
final readonly class DerivedFilterDefaultValue implements TypedAnnotationInterface
{
    use TypedAnnotationTrait;

    public const string TERM = 'com.sap.vocabularies.Common.v1.DerivedFilterDefaultValue';
